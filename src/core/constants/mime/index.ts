import { TextMimeType, MIME_TEXT } from './text'
import { FontMimeType, MIME_FONT } from './font'
import { ImageMimeType, MIME_IMAGE } from './image'
import { AudioMimeType, MIME_AUDIO } from './audio'
import { VideoMimeType, MIME_VIDEO } from './video'
import { AppMimeType , MIME_APP } from './application'
